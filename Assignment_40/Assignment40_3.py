...
df = pd.read_csv(dataPath,usecols=["StudyHours","Attendance","FinalResult"])
...
featuresColumns = ['StudyHours', 'Attendance']
...
mode = DecisionTreeClassifier(max_depth=1,random_state=42)
...
single_sample = pd.DataFrame([[6, 85]], columns=featuresColumns)
