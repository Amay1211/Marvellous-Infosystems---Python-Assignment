...
def main():
  ...
  if(len(sys.argv) == 2):
    if sys.argv[1] == "--h" or sys.argv[1] == "--H":
      ...
      print("2 : It fetch information about primary storage os RAM")
      print("3 : It fetch information about secondary storage os Harddisk")
      print("4 : information abour microprocessor")
      print("5 : it gets auto schedule periodiaclly")
      print("6 : it maintain all recorsd in to log file")
      print("7 :  it send log file through main periodically")
    elif sys.argv[1] == "--u" or sys.argv[1] == "--U":
      print("Use the automation script as : ")
      print(f"python {sys.argv[0]} timeInterval folderName")
  ...
  # actual project code
    ...
    procInfo(sys.argv[2])
    schedule.every(int(sys.argv[1])).minutes.do(procInfo,sys.argv[2])
    while True:
